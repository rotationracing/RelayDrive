...
use crate::broadcast_protocol::protocol::DecodeError;
...
pub enum CarModel {
    ...
    Ferrari488Evo,
    MercedesAMGEvo,
    FerrariF488Challenge,
    AudiR8GT2,
    MercedesAMGGT2,
    FerrariF488GT3Evo2020,
    MercedesAMGGT3_2020,
    FerrariF296GT3,
...
impl TryFrom<u8> for CarModel {
    ...
    fn try_from(value: u8) -> Result<Self, Self::Error> {
        match value {
            ...
            26 => Ok(CarModel::FerrariF488Challenge),
            27 => Ok(CarModel::AudiR8GT2),
            28 => Ok(CarModel::MercedesAMGGT2),
            29 => Ok(CarModel::FerrariF488GT3Evo2020),
            30 => Ok(CarModel::MercedesAMGGT3_2020),
            31 => Ok(CarModel::FerrariF296GT3),
            32 => Ok(CarModel::LamborghiniHuracanGT3Evo2),
            33 => Ok(CarModel::Porsche992GT3R),
            34 => Ok(CarModel::BMWM4GT3),
            35 => Ok(CarModel::AudiR8LMSEvoII),
            36 => Ok(CarModel::FerrariF296GT3), // Alternative ID for F296 GT3
...
impl Display for CarModel {
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        let str_name = match self {
            ...
            CarModel::FerrariF488Challenge => "Ferrari 488 Challenge Evo",
            CarModel::AudiR8GT2 => "Audi R8 GT2",
            CarModel::MercedesAMGGT2 => "Mercedes-AMG GT2",
            CarModel::FerrariF488GT3Evo2020 => "Ferrari 488 GT3 Evo 2020",
            CarModel::MercedesAMGGT3_2020 => "Mercedes-AMG GT3 2020",
            CarModel::FerrariF296GT3 => "Ferrari 296 GT3",
            CarModel::LamborghiniHuracanGT3Evo2 => "Lamborghini Huracan GT3 Evo2",
            CarModel::Porsche992GT3R => "Porsche 992 GT3 R",
            CarModel::BMWM4GT3 => "BMW M4 GT3",
            CarModel::AudiR8LMSEvoII => "Audi R8 LMS Evo II",
