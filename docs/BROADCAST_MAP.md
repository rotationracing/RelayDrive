  ...
  return (
    <div>
      ...
      <p>
        ...
        {(timeRemaining % 60).toFixed(0).padStart(2, "0")}
      </p>
  ...
  return (
    <div style={{ position: "relative", width: "100%", height: "400px" }}>
      <svg viewBox="0 0 1000 400">
        ...
        <ellipse cx="500" cy="200" rx="450" ry="150" fill="none" stroke="#333" strokeWidth="40" />
    ...
    <div>
      ...
      {events.map((event, i) => (
        <div key={i} style={{ padding: "8px", borderBottom: "1px solid #333" }}>
          ...
          <p>{event.msg}</p>
          <small>
            Car #{event.car_index} @ {(event.time_ms / 1000).toFixed(1)}s
          </small>
        </div>
      ))}
    </div>
