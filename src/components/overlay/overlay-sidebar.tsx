    ...
    <div className="flex flex-col h-full w-72 shrink-0 border-r border-border bg-transparent">
      ...
      <ScrollArea className="flex-1">
        <div className="p-1.5 space-y-0.5">
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between gap-2">
                  <span className="font-medium text-sm truncate leading-none">{overlay.title}</span>
                </div>
                {overlay.description && (
              ...
              <div
                ...
                className="flex shrink-0 items-center justify-center h-full"
              >
                <Switch
          ...
          {filtered.length === 0 && (
            <div className="p-8 text-center text-muted-foreground text-sm">No overlays found</div>
          )}
        </div>
      </ScrollArea>
    </div>
