...
export function OverlaySettingsPanel({
    ...
    const categories = Object.entries(settingsByCategory).filter(([_, settings]) => settings.length > 0)
    ...
    const currentTab = categories.find(c => c[0] === activeTab) ? activeTab : categories[0]?.[0] || "Basic"
                                            ...
                                            <div className="shrink-0">
                                                ...
                                                {isSlider && (
                                                    <div className="flex items-center gap-3 w-[280px]">
                                                        ...
                                                        />
                                                        <Badge variant="outline" className="font-mono text-[10px] h-5 w-14 justify-center">
                                                            {displayValue}{unit}
                                                        </Badge>
                                                    </div>
                                                )}
                                                        ...
                                                        <PopoverTrigger asChild>
                                                            ...
                                                            >
                                                                ...
                                                                <span className="text-xs text-muted-foreground font-mono truncate">
                                                                    #{Math.round(colorValue[0]).toString(16).padStart(2, '0')}{Math.round(colorValue[1]).toString(16).padStart(2, '0')}{Math.round(colorValue[2]).toString(16).padStart(2, '0')}
                                                                </span>
                                                            </Button>
                                                        </PopoverTrigger>
