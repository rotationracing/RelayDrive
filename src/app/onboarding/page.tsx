...
export default function OnboardingPage() {
  ...
  const handleLoginAccount = async () => {
    ...
    try {
      ...
      setAuthError(
        "We couldn't open your default browser automatically. Copy the link below and paste it into your browser.",
      );
    }
  };
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex items-center justify-center px-6">
            ...
            <div className="mt-3 text-sm">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  onClick={() =>
                    navigator.clipboard.writeText("https://relaydrive.rotationracing.eu/auth")
                  }
                >
                  Copy
                </button>
      ...
      {step === "welcome" && (
        <div className="w-full max-w-xl text-center">
          <h2 className="text-2xl md:text-3xl font-semibold">
            Thank you for installing RelayDrive
          </h2>
      ...
      {step === "data-sharing" && (
        <div className="w-full max-w-2xl">
          <h4 className="text-xl md:text-2xl font-semibold text-center mb-2">
            Help us improve RelayDrive
          </h4>
          <p className="text-center text-sm text-muted-foreground mb-6">
            Share usage data to help make RelayDrive better
          </p>
              ...
              <div className="flex items-start gap-4">
                <div className="flex-1">
                  ...
                  <div className="text-xs text-muted-foreground italic flex items-center gap-2">
                    <span>
                      Even with sharing off, some online features may require limited diagnostics.
                    </span>
                    <Tooltip>
                      ...
                      >
                        If you later enable online features of RelayDrive Pro, some required
                        information will still be sent so those services can function correctly.
                      </TooltipContent>
                    </Tooltip>
                  </div>
                </div>
      ...
      {step === "pro-subscription" && (
        <div className="w-full max-w-2xl">
          ...
          <p className="text-center text-sm text-muted-foreground mb-6">
            Get advanced analysis and cloud features for 5€ per month
          </p>
          <div className="mx-auto w-full max-w-lg">
            ...
            <div className="flex items-start gap-3 mb-6">
              ...
              <div className="flex-1">
                <h5 className="text-base font-semibold mb-2">
                  Limit your in-game FPS for smooth overlays
                </h5>
                <p className="text-sm text-muted-foreground mb-4">
                  To avoid stutter and lag, cap your in-game FPS slightly below your stable maximum
                  so the overlay has headroom to render.
                </p>
                <div className="rounded-md border border-white/10 bg-black/20 p-4 mb-3">
                  ...
                  <p className="text-sm">
                    If your game is stable at{" "}
                    <span className="font-semibold text-brand">120 FPS</span>, set a limit to{" "}
                    <span className="font-semibold text-brand">100–110 FPS</span>.
                  </p>
                </div>
                <p className="text-xs text-muted-foreground">
                  This buffer ensures the overlay doesn't compete with the game for system
                  resources.
                </p>
              </div>
            </div>
      ...
      {step === "welcome-back" && (
        <div
          className={`w-full max-w-xl text-center transition-opacity duration-1000 ease-in-out ${welcomeFade ? "opacity-0" : "opacity-100"}`}
        >
